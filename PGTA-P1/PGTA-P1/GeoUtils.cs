...
namespace MultiCAT6.Utils
{
    ...
    public class GeoUtils
    {
        ...
        public double change_system_xyh2system_z(CoordinatesXYH c)
        {
            ...
            {
                z = (this.R_S + c.Height) * Math.Sqrt(1.0 - temp) - (this.R_S + this.centerProjection.Height);
            }
            return z;
        }
        /// <summary>
        ...
        public double CalculateElevation(CoordinatesWGS84 centerCoordinates, double R, double rho, double h)
        {
        ...
        static public CoordinatesPolar change_radar_cartesian2radar_spherical(CoordinatesXYZ cartesianCoordinates)
        {
            ...
            res.Rho = Math.Sqrt(cartesianCoordinates.X * cartesianCoordinates.X + cartesianCoordinates.Y * cartesianCoordinates.Y + cartesianCoordinates.Z * cartesianCoordinates.Z);
